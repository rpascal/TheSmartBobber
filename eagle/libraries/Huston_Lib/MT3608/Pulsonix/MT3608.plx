...
(library Library_1
	...
	(compDef "MT3608" (originalName "MT3608") (compHeader (numPins 6) (numParts 1) (refDesPrefix U)
		...
		(compPin "6" (pinName "NC") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.olimex.com/Products/Breadboarding/BB-PWR-3608/resources/MT3608.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "MT3608.stp")
	)
